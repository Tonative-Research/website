    ...
    <section>
      <div className="from-accent-600 via-accent-500 to-accent-600 flex items-center justify-center gap-3 border-b border-white/10 bg-gradient-to-r px-4 py-2.5 text-white shadow-lg">
        ...
        <Link href="/services/data-academy">
          <button className="text-accent-600 ml-1 shrink-0 rounded-full bg-white px-4 py-1 text-sm font-semibold shadow-sm transition hover:-translate-y-0.5 hover:shadow-md">
            Apply Now
          </button>
        </Link>
      </div>
