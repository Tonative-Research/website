    ...
    <section className="bg-white py-16">
      <div className="container mx-auto px-4 sm:px-10">
        <div className="from-primary-900 via-primary-800 relative overflow-hidden rounded-2xl bg-linear-to-br to-slate-950 px-8 py-12 sm:px-12 lg:px-16">
          ...
          <div className="bg-primary-600/20 absolute top-0 right-0 h-64 w-64 animate-pulse rounded-full blur-3xl" />
          ...
          <div className="relative flex flex-col items-start gap-8 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              <button
                type="button"
                disabled
                className="w-full cursor-not-allowed rounded-lg bg-gray-500 px-8 py-3.5 text-sm font-bold text-white opacity-70 sm:w-auto"
              >
                Applications Closed
              </button>
              ...
              <Link href="/services/data-academy#curriculum">
                <button
                  type="button"
                  className="w-full cursor-pointer rounded-lg border border-white/30 bg-white/10 px-8 py-3.5 text-sm font-medium text-white backdrop-blur-sm transition-colors hover:bg-white/20 sm:w-auto"
                >
                  View Curriculum
                </button>
              </Link>
